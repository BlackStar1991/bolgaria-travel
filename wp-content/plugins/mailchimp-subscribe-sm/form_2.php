...
<div id='sm_wrapper'>
	...
	<div id='sm_form_wrapper'>
		<?php echo get_post_meta($post->ID,'ssm_select_data_save_method',true); ?>
			<p>
				<input type='text' id='sm_name' class='sm_field' name='sm_email' placeholder='Enter Your Name ' required >
				<input type='email' id='sm_email' class='sm_field' name='sm_email' placeholder='Enter Your Email ' required >
