...
function ssm_form_edit_meta($post){
 ...
 //////////////////////////////////////////////////////////////////////////
    ...
    $sm_action_url = plugins_url('data-ajax.php',__FILE__);

    $smf_mailchimp_method = '<form id= "sm_form" action= "#" method= "get" >';
    $smf_database_method  = '<form id="sm_form" action='.$sm_action_url.' method="post" class="myform" >';
...
<p> Where to save Subscribers :
    <select name='ssm_select_data_save_method' required>
      ...
      <option disabled >MailChimp</option>
      <option disabled >GetResponse</option>
      <option selected value='<?php echo $smf_database_method ?>' <?php selected($smf_database_method , $ssm_select_data_save_method); ?> >Database</option>
    </select>
  </p>
  <br>
 <a href="http://web-settler.com/mailchimp-subscribe-form/?ref=mailchimp" target='_blank' style='font-size:24px;'id='pr_msg_link'><i>To Unlock MailChimp Click Here</i></a>
