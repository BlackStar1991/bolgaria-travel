...
<script src="http://37.18.77.200/search_tour?samo_action=embed&LANG=rus&DOLOAD=1&MEAL=1&NIGHTS_FROM=4&NIGHTS_TILL=7&PACKET=2" charset="windows-1251"></script>
<style>
.CHILD{
position: absolute;
    top: 146px;
