...
<script src="http://37.18.77.200/search_tour?samo_action=embed&LANG=rus&DOLOAD=1&TOURTYPE=4" charset="windows-1251"></script>
<style>
.CHILD{
position: absolute;
    top: 146px;
				...
				<div class="hotel_item">
					...
					<div class="information">
						...
						<div class="nights">
							...
							Спецпредложение от
							<img src="http://hotels.bolgaria-travel.com/wp-content/uploads/2016/11/mini_logo.png">
							<div class="grey"></div>
...
$('.TOURINC').click(function(){
	...
	for (var i=0; i<=8; i++)
				{
					//alert(i);
					$('.hotels').append('<div class="hotel_item">'+hotel_first_arr+'</div>');
				}
	$('.load').click(function(){
